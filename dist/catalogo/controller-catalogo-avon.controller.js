...
__decorate([
    (0, common_2.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Devuelve todo' }),
...
__decorate([
    (0, common_1.Patch)('/:id'),
    (0, common_1.UsePipes)(common_3.ValidationPipe),
    (0, swagger_1.ApiOperation)({ summary: 'Se edita el producto' }),
    __param(0, (0, common_2.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Se elimina el producto' }),
    __param(0, (0, common_2.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
